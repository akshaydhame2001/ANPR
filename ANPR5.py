...
config = {
    'mmt_model_file': "/content/drive/MyDrive/Unilactic/model-weights-spectrico-mmr-mobilenet-128x128-344FF72B.pb",
    'mmt_label_file': "/content/drive/MyDrive/Unilactic/classifier_MMT.txt",
    'mmt_input_layer': "input_1",
    'mmt_output_layer': "softmax/Softmax",
    'mmt_input_size': (128, 128),
    'license_plate_model_path': "/content/drive/MyDrive/Unilactic/license_plate_detector.pt",
    'color_model_path': "/content/drive/MyDrive/Unilactic/VCoRPChen.pt",
    'yolo_model_path': "/content/drive/MyDrive/Unilactic/yolov8s.pt",
...
def main():
    ...
    match_thresh=0.8,
    track_buffer=30,  # If the library doesn't support this, remove it
    mot20=False
    )
    ...
    byte_tracker = BYTETracker(tracker_args, frame_rate=30)
        ...
        while True:
            ...
            for obj in tracked_objects:
                ...
                if car_class == 2:  # For cars, combine Make/Model and Color
                    ...
                    combined_label = config['vehicle_classes'].get(car_class, "Unknown") + " " + str(color_label)
