...
def main():
    ...
    with tf.compat.v1.Session(graph=mmt_graph) as mmt_sess:
        ...
        while True:
            ...
            for obj in tracked_objects:
                ...
                text_position = (int(x1 + 5), int(y1 - 10)) if (x1 and y1) else None
                bg_color = (0, 0, 0)
                ...
                if text_position is not None:
                    ...
                    cv2.rectangle(frame, (int(text_position[0] - 5), int(text_position[1] - text_size[1] - 5)), (int(text_position[0] + text_size[0] + 5), int(text_position[1] + 5)), bg_color, -1)  # Black background
    ...
    out.release()
    # Write results to CSV
    write_csv(results, '/content/results.csv')
